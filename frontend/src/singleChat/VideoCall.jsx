...
const RoomPage = (userId,chatId) => {

    const navigate= useNavigate();
    const socket = io("localhost:8000") //initializing Socket
    const formData={ email: userId, room: chatId }
    // All States
    ...
    return (
        <div>
            ...
            <div>
                ...
                <button onClick={handleCallUser} className='btn'>CALL</button>
            ...
            <div className='flex gap-1 w-full max-[700px]:flex-col'>
                ...
                <div className='bg-green-400 w-1/2 max-[700px]:w-full h-[50%] min-[700px]:h-[90vh] flex flex-col justify-center items-center'>
                    ...
                    {<button className='btn hover:bg-green-500 active:bg-blue-800'   onClick={sendStreams}>Accept Call</button>}
